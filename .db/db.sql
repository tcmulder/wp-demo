...
--
-- Table structure for table `d503h1e7s1_commentmeta`
--

DROP TABLE IF EXISTS `d503h1e7s1_commentmeta`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `d503h1e7s1_commentmeta` (
...
--
-- Dumping data for table `d503h1e7s1_commentmeta`
--

LOCK TABLES `d503h1e7s1_commentmeta` WRITE;
/*!40000 ALTER TABLE `d503h1e7s1_commentmeta` DISABLE KEYS */;
/*!40000 ALTER TABLE `d503h1e7s1_commentmeta` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `d503h1e7s1_comments`
--

DROP TABLE IF EXISTS `d503h1e7s1_comments`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `d503h1e7s1_comments` (
...
--
-- Dumping data for table `d503h1e7s1_comments`
--

LOCK TABLES `d503h1e7s1_comments` WRITE;
/*!40000 ALTER TABLE `d503h1e7s1_comments` DISABLE KEYS */;
INSERT INTO `d503h1e7s1_comments` VALUES (1,1,'A WordPress Commenter','wapuu@wordpress.example','https://wordpress.org/','','2017-01-14 19:43:09','2017-01-14 19:43:09','Hi, this is a comment.\nTo get started with moderating, editing, and deleting comments, please visit the Comments screen in the dashboard.\nCommenter avatars come from <a href=\"https://gravatar.com\">Gravatar</a>.',0,'1','','',0,0);
/*!40000 ALTER TABLE `d503h1e7s1_comments` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `d503h1e7s1_links`
--

DROP TABLE IF EXISTS `d503h1e7s1_links`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `d503h1e7s1_links` (
...
--
-- Dumping data for table `d503h1e7s1_links`
--

LOCK TABLES `d503h1e7s1_links` WRITE;
/*!40000 ALTER TABLE `d503h1e7s1_links` DISABLE KEYS */;
/*!40000 ALTER TABLE `d503h1e7s1_links` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `d503h1e7s1_options`
--

DROP TABLE IF EXISTS `d503h1e7s1_options`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `d503h1e7s1_options` (
...
--
-- Dumping data for table `d503h1e7s1_options`
--

LOCK TABLES `d503h1e7s1_options` WRITE;
/*!40000 ALTER TABLE `d503h1e7s1_options` DISABLE KEYS */;
INSERT INTO `d503h1e7s1_options` VALUES (1,'siteurl','http://localhost','yes');
INSERT INTO `d503h1e7s1_options` VALUES (2,'home','http://localhost','yes');
INSERT INTO `d503h1e7s1_options` VALUES (3,'blogname','Demo Site','yes');
INSERT INTO `d503h1e7s1_options` VALUES (4,'blogdescription','Just another demo site','yes');
INSERT INTO `d503h1e7s1_options` VALUES (5,'users_can_register','0','yes');
INSERT INTO `d503h1e7s1_options` VALUES (6,'admin_email','tcmulder@gmail.com','yes');
INSERT INTO `d503h1e7s1_options` VALUES (7,'start_of_week','1','yes');
INSERT INTO `d503h1e7s1_options` VALUES (8,'use_balanceTags','0','yes');
INSERT INTO `d503h1e7s1_options` VALUES (9,'use_smilies','1','yes');
INSERT INTO `d503h1e7s1_options` VALUES (10,'require_name_email','1','yes');
INSERT INTO `d503h1e7s1_options` VALUES (11,'comments_notify','1','yes');
INSERT INTO `d503h1e7s1_options` VALUES (12,'posts_per_rss','10','yes');
INSERT INTO `d503h1e7s1_options` VALUES (13,'rss_use_excerpt','0','yes');
INSERT INTO `d503h1e7s1_options` VALUES (14,'mailserver_url','mail.example.com','yes');
INSERT INTO `d503h1e7s1_options` VALUES (15,'mailserver_login','login@example.com','yes');
INSERT INTO `d503h1e7s1_options` VALUES (16,'mailserver_pass','password','yes');
INSERT INTO `d503h1e7s1_options` VALUES (17,'mailserver_port','110','yes');
INSERT INTO `d503h1e7s1_options` VALUES (18,'default_category','1','yes');
INSERT INTO `d503h1e7s1_options` VALUES (19,'default_comment_status','closed','yes');
INSERT INTO `d503h1e7s1_options` VALUES (20,'default_ping_status','open','yes');
INSERT INTO `d503h1e7s1_options` VALUES (21,'default_pingback_flag','1','yes');
INSERT INTO `d503h1e7s1_options` VALUES (22,'posts_per_page','10','yes');
INSERT INTO `d503h1e7s1_options` VALUES (23,'date_format','F j, Y','yes');
INSERT INTO `d503h1e7s1_options` VALUES (24,'time_format','g:i a','yes');
INSERT INTO `d503h1e7s1_options` VALUES (25,'links_updated_date_format','F j, Y g:i a','yes');
INSERT INTO `d503h1e7s1_options` VALUES (26,'comment_moderation','','yes');
INSERT INTO `d503h1e7s1_options` VALUES (27,'moderation_notify','1','yes');
INSERT INTO `d503h1e7s1_options` VALUES (28,'permalink_structure','/%category%/%postname%/','yes');
INSERT INTO `d503h1e7s1_options` VALUES (29,'rewrite_rules','a:94:{s:11:\"^wp-json/?$\";s:22:\"index.php?rest_route=/\";s:14:\"^wp-json/(.*)?\";s:33:\"index.php?rest_route=/$matches[1]\";s:21:\"^index.php/wp-json/?$\";s:22:\"index.php?rest_route=/\";s:24:\"^index.php/wp-json/(.*)?\";s:33:\"index.php?rest_route=/$matches[1]\";s:47:\"category/(.+?)/feed/(feed|rdf|rss|rss2|atom)/?$\";s:52:\"index.php?category_name=$matches[1]&feed=$matches[2]\";s:42:\"category/(.+?)/(feed|rdf|rss|rss2|atom)/?$\";s:52:\"index.php?category_name=$matches[1]&feed=$matches[2]\";s:23:\"category/(.+?)/embed/?$\";s:46:\"index.php?category_name=$matches[1]&embed=true\";s:35:\"category/(.+?)/page/?([0-9]{1,})/?$\";s:53:\"index.php?category_name=$matches[1]&paged=$matches[2]\";s:17:\"category/(.+?)/?$\";s:35:\"index.php?category_name=$matches[1]\";s:44:\"tag/([^/]+)/feed/(feed|rdf|rss|rss2|atom)/?$\";s:42:\"index.php?tag=$matches[1]&feed=$matches[2]\";s:39:\"tag/([^/]+)/(feed|rdf|rss|rss2|atom)/?$\";s:42:\"index.php?tag=$matches[1]&feed=$matches[2]\";s:20:\"tag/([^/]+)/embed/?$\";s:36:\"index.php?tag=$matches[1]&embed=true\";s:32:\"tag/([^/]+)/page/?([0-9]{1,})/?$\";s:43:\"index.php?tag=$matches[1]&paged=$matches[2]\";s:14:\"tag/([^/]+)/?$\";s:25:\"index.php?tag=$matches[1]\";s:45:\"type/([^/]+)/feed/(feed|rdf|rss|rss2|atom)/?$\";s:50:\"index.php?post_format=$matches[1]&feed=$matches[2]\";s:40:\"type/([^/]+)/(feed|rdf|rss|rss2|atom)/?$\";s:50:\"index.php?post_format=$matches[1]&feed=$matches[2]\";s:21:\"type/([^/]+)/embed/?$\";s:44:\"index.php?post_format=$matches[1]&embed=true\";s:33:\"type/([^/]+)/page/?([0-9]{1,})/?$\";s:51:\"index.php?post_format=$matches[1]&paged=$matches[2]\";s:15:\"type/([^/]+)/?$\";s:33:\"index.php?post_format=$matches[1]\";s:12:\"robots\\.txt$\";s:18:\"index.php?robots=1\";s:48:\".*wp-(atom|rdf|rss|rss2|feed|commentsrss2)\\.php$\";s:18:\"index.php?feed=old\";s:20:\".*wp-app\\.php(/.*)?$\";s:19:\"index.php?error=403\";s:18:\".*wp-register.php$\";s:23:\"index.php?register=true\";s:32:\"feed/(feed|rdf|rss|rss2|atom)/?$\";s:27:\"index.php?&feed=$matches[1]\";s:27:\"(feed|rdf|rss|rss2|atom)/?$\";s:27:\"index.php?&feed=$matches[1]\";s:8:\"embed/?$\";s:21:\"index.php?&embed=true\";s:20:\"page/?([0-9]{1,})/?$\";s:28:\"index.php?&paged=$matches[1]\";s:27:\"comment-page-([0-9]{1,})/?$\";s:38:\"index.php?&page_id=2&cpage=$matches[1]\";s:41:\"comments/feed/(feed|rdf|rss|rss2|atom)/?$\";s:42:\"index.php?&feed=$matches[1]&withcomments=1\";s:36:\"comments/(feed|rdf|rss|rss2|atom)/?$\";s:42:\"index.php?&feed=$matches[1]&withcomments=1\";s:17:\"comments/embed/?$\";s:21:\"index.php?&embed=true\";s:44:\"search/(.+)/feed/(feed|rdf|rss|rss2|atom)/?$\";s:40:\"index.php?s=$matches[1]&feed=$matches[2]\";s:39:\"search/(.+)/(feed|rdf|rss|rss2|atom)/?$\";s:40:\"index.php?s=$matches[1]&feed=$matches[2]\";s:20:\"search/(.+)/embed/?$\";s:34:\"index.php?s=$matches[1]&embed=true\";s:32:\"search/(.+)/page/?([0-9]{1,})/?$\";s:41:\"index.php?s=$matches[1]&paged=$matches[2]\";s:14:\"search/(.+)/?$\";s:23:\"index.php?s=$matches[1]\";s:47:\"author/([^/]+)/feed/(feed|rdf|rss|rss2|atom)/?$\";s:50:\"index.php?author_name=$matches[1]&feed=$matches[2]\";s:42:\"author/([^/]+)/(feed|rdf|rss|rss2|atom)/?$\";s:50:\"index.php?author_name=$matches[1]&feed=$matches[2]\";s:23:\"author/([^/]+)/embed/?$\";s:44:\"index.php?author_name=$matches[1]&embed=true\";s:35:\"author/([^/]+)/page/?([0-9]{1,})/?$\";s:51:\"index.php?author_name=$matches[1]&paged=$matches[2]\";s:17:\"author/([^/]+)/?$\";s:33:\"index.php?author_name=$matches[1]\";s:69:\"([0-9]{4})/([0-9]{1,2})/([0-9]{1,2})/feed/(feed|rdf|rss|rss2|atom)/?$\";s:80:\"index.php?year=$matches[1]&monthnum=$matches[2]&day=$matches[3]&feed=$matches[4]\";s:64:\"([0-9]{4})/([0-9]{1,2})/([0-9]{1,2})/(feed|rdf|rss|rss2|atom)/?$\";s:80:\"index.php?year=$matches[1]&monthnum=$matches[2]&day=$matches[3]&feed=$matches[4]\";s:45:\"([0-9]{4})/([0-9]{1,2})/([0-9]{1,2})/embed/?$\";s:74:\"index.php?year=$matches[1]&monthnum=$matches[2]&day=$matches[3]&embed=true\";s:57:\"([0-9]{4})/([0-9]{1,2})/([0-9]{1,2})/page/?([0-9]{1,})/?$\";s:81:\"index.php?year=$matches[1]&monthnum=$matches[2]&day=$matches[3]&paged=$matches[4]\";s:39:\"([0-9]{4})/([0-9]{1,2})/([0-9]{1,2})/?$\";s:63:\"index.php?year=$matches[1]&monthnum=$matches[2]&day=$matches[3]\";s:56:\"([0-9]{4})/([0-9]{1,2})/feed/(feed|rdf|rss|rss2|atom)/?$\";s:64:\"index.php?year=$matches[1]&monthnum=$matches[2]&feed=$matches[3]\";s:51:\"([0-9]{4})/([0-9]{1,2})/(feed|rdf|rss|rss2|atom)/?$\";s:64:\"index.php?year=$matches[1]&monthnum=$matches[2]&feed=$matches[3]\";s:32:\"([0-9]{4})/([0-9]{1,2})/embed/?$\";s:58:\"index.php?year=$matches[1]&monthnum=$matches[2]&embed=true\";s:44:\"([0-9]{4})/([0-9]{1,2})/page/?([0-9]{1,})/?$\";s:65:\"index.php?year=$matches[1]&monthnum=$matches[2]&paged=$matches[3]\";s:26:\"([0-9]{4})/([0-9]{1,2})/?$\";s:47:\"index.php?year=$matches[1]&monthnum=$matches[2]\";s:43:\"([0-9]{4})/feed/(feed|rdf|rss|rss2|atom)/?$\";s:43:\"index.php?year=$matches[1]&feed=$matches[2]\";s:38:\"([0-9]{4})/(feed|rdf|rss|rss2|atom)/?$\";s:43:\"index.php?year=$matches[1]&feed=$matches[2]\";s:19:\"([0-9]{4})/embed/?$\";s:37:\"index.php?year=$matches[1]&embed=true\";s:31:\"([0-9]{4})/page/?([0-9]{1,})/?$\";s:44:\"index.php?year=$matches[1]&paged=$matches[2]\";s:13:\"([0-9]{4})/?$\";s:26:\"index.php?year=$matches[1]\";s:27:\".?.+?/attachment/([^/]+)/?$\";s:32:\"index.php?attachment=$matches[1]\";s:37:\".?.+?/attachment/([^/]+)/trackback/?$\";s:37:\"index.php?attachment=$matches[1]&tb=1\";s:57:\".?.+?/attachment/([^/]+)/feed/(feed|rdf|rss|rss2|atom)/?$\";s:49:\"index.php?attachment=$matches[1]&feed=$matches[2]\";s:52:\".?.+?/attachment/([^/]+)/(feed|rdf|rss|rss2|atom)/?$\";s:49:\"index.php?attachment=$matches[1]&feed=$matches[2]\";s:52:\".?.+?/attachment/([^/]+)/comment-page-([0-9]{1,})/?$\";s:50:\"index.php?attachment=$matches[1]&cpage=$matches[2]\";s:33:\".?.+?/attachment/([^/]+)/embed/?$\";s:43:\"index.php?attachment=$matches[1]&embed=true\";s:16:\"(.?.+?)/embed/?$\";s:41:\"index.php?pagename=$matches[1]&embed=true\";s:20:\"(.?.+?)/trackback/?$\";s:35:\"index.php?pagename=$matches[1]&tb=1\";s:40:\"(.?.+?)/feed/(feed|rdf|rss|rss2|atom)/?$\";s:47:\"index.php?pagename=$matches[1]&feed=$matches[2]\";s:35:\"(.?.+?)/(feed|rdf|rss|rss2|atom)/?$\";s:47:\"index.php?pagename=$matches[1]&feed=$matches[2]\";s:28:\"(.?.+?)/page/?([0-9]{1,})/?$\";s:48:\"index.php?pagename=$matches[1]&paged=$matches[2]\";s:35:\"(.?.+?)/comment-page-([0-9]{1,})/?$\";s:48:\"index.php?pagename=$matches[1]&cpage=$matches[2]\";s:24:\"(.?.+?)(?:/([0-9]+))?/?$\";s:47:\"index.php?pagename=$matches[1]&page=$matches[2]\";s:31:\".+?/[^/]+/attachment/([^/]+)/?$\";s:32:\"index.php?attachment=$matches[1]\";s:41:\".+?/[^/]+/attachment/([^/]+)/trackback/?$\";s:37:\"index.php?attachment=$matches[1]&tb=1\";s:61:\".+?/[^/]+/attachment/([^/]+)/feed/(feed|rdf|rss|rss2|atom)/?$\";s:49:\"index.php?attachment=$matches[1]&feed=$matches[2]\";s:56:\".+?/[^/]+/attachment/([^/]+)/(feed|rdf|rss|rss2|atom)/?$\";s:49:\"index.php?attachment=$matches[1]&feed=$matches[2]\";s:56:\".+?/[^/]+/attachment/([^/]+)/comment-page-([0-9]{1,})/?$\";s:50:\"index.php?attachment=$matches[1]&cpage=$matches[2]\";s:37:\".+?/[^/]+/attachment/([^/]+)/embed/?$\";s:43:\"index.php?attachment=$matches[1]&embed=true\";s:22:\"(.+?)/([^/]+)/embed/?$\";s:63:\"index.php?category_name=$matches[1]&name=$matches[2]&embed=true\";s:26:\"(.+?)/([^/]+)/trackback/?$\";s:57:\"index.php?category_name=$matches[1]&name=$matches[2]&tb=1\";s:46:\"(.+?)/([^/]+)/feed/(feed|rdf|rss|rss2|atom)/?$\";s:69:\"index.php?category_name=$matches[1]&name=$matches[2]&feed=$matches[3]\";s:41:\"(.+?)/([^/]+)/(feed|rdf|rss|rss2|atom)/?$\";s:69:\"index.php?category_name=$matches[1]&name=$matches[2]&feed=$matches[3]\";s:34:\"(.+?)/([^/]+)/page/?([0-9]{1,})/?$\";s:70:\"index.php?category_name=$matches[1]&name=$matches[2]&paged=$matches[3]\";s:41:\"(.+?)/([^/]+)/comment-page-([0-9]{1,})/?$\";s:70:\"index.php?category_name=$matches[1]&name=$matches[2]&cpage=$matches[3]\";s:30:\"(.+?)/([^/]+)(?:/([0-9]+))?/?$\";s:69:\"index.php?category_name=$matches[1]&name=$matches[2]&page=$matches[3]\";s:20:\".+?/[^/]+/([^/]+)/?$\";s:32:\"index.php?attachment=$matches[1]\";s:30:\".+?/[^/]+/([^/]+)/trackback/?$\";s:37:\"index.php?attachment=$matches[1]&tb=1\";s:50:\".+?/[^/]+/([^/]+)/feed/(feed|rdf|rss|rss2|atom)/?$\";s:49:\"index.php?attachment=$matches[1]&feed=$matches[2]\";s:45:\".+?/[^/]+/([^/]+)/(feed|rdf|rss|rss2|atom)/?$\";s:49:\"index.php?attachment=$matches[1]&feed=$matches[2]\";s:45:\".+?/[^/]+/([^/]+)/comment-page-([0-9]{1,})/?$\";s:50:\"index.php?attachment=$matches[1]&cpage=$matches[2]\";s:26:\".+?/[^/]+/([^/]+)/embed/?$\";s:43:\"index.php?attachment=$matches[1]&embed=true\";s:38:\"(.+?)/feed/(feed|rdf|rss|rss2|atom)/?$\";s:52:\"index.php?category_name=$matches[1]&feed=$matches[2]\";s:33:\"(.+?)/(feed|rdf|rss|rss2|atom)/?$\";s:52:\"index.php?category_name=$matches[1]&feed=$matches[2]\";s:14:\"(.+?)/embed/?$\";s:46:\"index.php?category_name=$matches[1]&embed=true\";s:26:\"(.+?)/page/?([0-9]{1,})/?$\";s:53:\"index.php?category_name=$matches[1]&paged=$matches[2]\";s:33:\"(.+?)/comment-page-([0-9]{1,})/?$\";s:53:\"index.php?category_name=$matches[1]&cpage=$matches[2]\";s:8:\"(.+?)/?$\";s:35:\"index.php?category_name=$matches[1]\";}','yes');
INSERT INTO `d503h1e7s1_options` VALUES (30,'hack_file','0','yes');
INSERT INTO `d503h1e7s1_options` VALUES (31,'blog_charset','UTF-8','yes');
INSERT INTO `d503h1e7s1_options` VALUES (32,'moderation_keys','','no');
INSERT INTO `d503h1e7s1_options` VALUES (33,'active_plugins','a:4:{i:0;s:30:\"advanced-custom-fields/acf.php\";i:1;s:21:\"imsanity/imsanity.php\";i:2;s:41:\"simple-image-sizes/simple_image_sizes.php\";i:3;s:31:\"what-the-file/what-the-file.php\";}','yes');
INSERT INTO `d503h1e7s1_options` VALUES (34,'category_base','','yes');
INSERT INTO `d503h1e7s1_options` VALUES (35,'ping_sites','http://rpc.pingomatic.com/','yes');
INSERT INTO `d503h1e7s1_options` VALUES (36,'comment_max_links','2','yes');
INSERT INTO `d503h1e7s1_options` VALUES (37,'gmt_offset','0','yes');
INSERT INTO `d503h1e7s1_options` VALUES (38,'default_email_category','1','yes');
INSERT INTO `d503h1e7s1_options` VALUES (39,'recently_edited','','no');
INSERT INTO `d503h1e7s1_options` VALUES (40,'template','legion','yes');
INSERT INTO `d503h1e7s1_options` VALUES (41,'stylesheet','legion','yes');
INSERT INTO `d503h1e7s1_options` VALUES (42,'comment_whitelist','1','yes');
INSERT INTO `d503h1e7s1_options` VALUES (43,'blacklist_keys','','no');
INSERT INTO `d503h1e7s1_options` VALUES (44,'comment_registration','','yes');
INSERT INTO `d503h1e7s1_options` VALUES (45,'html_type','text/html','yes');
INSERT INTO `d503h1e7s1_options` VALUES (46,'use_trackback','0','yes');
INSERT INTO `d503h1e7s1_options` VALUES (47,'default_role','subscriber','yes');
INSERT INTO `d503h1e7s1_options` VALUES (48,'db_version','38590','yes');
INSERT INTO `d503h1e7s1_options` VALUES (49,'uploads_use_yearmonth_folders','1','yes');
INSERT INTO `d503h1e7s1_options` VALUES (50,'upload_path','','yes');
INSERT INTO `d503h1e7s1_options` VALUES (51,'blog_public','1','yes');
INSERT INTO `d503h1e7s1_options` VALUES (52,'default_link_category','2','yes');
INSERT INTO `d503h1e7s1_options` VALUES (53,'show_on_front','page','yes');
INSERT INTO `d503h1e7s1_options` VALUES (54,'tag_base','','yes');
INSERT INTO `d503h1e7s1_options` VALUES (55,'show_avatars','1','yes');
INSERT INTO `d503h1e7s1_options` VALUES (56,'avatar_rating','G','yes');
INSERT INTO `d503h1e7s1_options` VALUES (57,'upload_url_path','','yes');
INSERT INTO `d503h1e7s1_options` VALUES (58,'thumbnail_size_w','150','yes');
INSERT INTO `d503h1e7s1_options` VALUES (59,'thumbnail_size_h','150','yes');
INSERT INTO `d503h1e7s1_options` VALUES (60,'thumbnail_crop','1','yes');
INSERT INTO `d503h1e7s1_options` VALUES (61,'medium_size_w','300','yes');
INSERT INTO `d503h1e7s1_options` VALUES (62,'medium_size_h','300','yes');
INSERT INTO `d503h1e7s1_options` VALUES (63,'avatar_default','mystery','yes');
INSERT INTO `d503h1e7s1_options` VALUES (64,'large_size_w','1024','yes');
INSERT INTO `d503h1e7s1_options` VALUES (65,'large_size_h','1024','yes');
INSERT INTO `d503h1e7s1_options` VALUES (66,'image_default_link_type','none','yes');
INSERT INTO `d503h1e7s1_options` VALUES (67,'image_default_size','','yes');
INSERT INTO `d503h1e7s1_options` VALUES (68,'image_default_align','','yes');
INSERT INTO `d503h1e7s1_options` VALUES (69,'close_comments_for_old_posts','','yes');
INSERT INTO `d503h1e7s1_options` VALUES (70,'close_comments_days_old','14','yes');
INSERT INTO `d503h1e7s1_options` VALUES (71,'thread_comments','1','yes');
INSERT INTO `d503h1e7s1_options` VALUES (72,'thread_comments_depth','5','yes');
INSERT INTO `d503h1e7s1_options` VALUES (73,'page_comments','','yes');
INSERT INTO `d503h1e7s1_options` VALUES (74,'comments_per_page','50','yes');
INSERT INTO `d503h1e7s1_options` VALUES (75,'default_comments_page','newest','yes');
INSERT INTO `d503h1e7s1_options` VALUES (76,'comment_order','asc','yes');
INSERT INTO `d503h1e7s1_options` VALUES (77,'sticky_posts','a:0:{}','yes');
INSERT INTO `d503h1e7s1_options` VALUES (78,'widget_categories','a:2:{i:2;a:4:{s:5:\"title\";s:0:\"\";s:5:\"count\";i:0;s:12:\"hierarchical\";i:0;s:8:\"dropdown\";i:0;}s:12:\"_multiwidget\";i:1;}','yes');
INSERT INTO `d503h1e7s1_options` VALUES (79,'widget_text','a:0:{}','yes');
INSERT INTO `d503h1e7s1_options` VALUES (80,'widget_rss','a:0:{}','yes');
INSERT INTO `d503h1e7s1_options` VALUES (81,'uninstall_plugins','a:0:{}','no');
INSERT INTO `d503h1e7s1_options` VALUES (82,'timezone_string','','yes');
INSERT INTO `d503h1e7s1_options` VALUES (83,'page_for_posts','0','yes');
INSERT INTO `d503h1e7s1_options` VALUES (84,'page_on_front','2','yes');
INSERT INTO `d503h1e7s1_options` VALUES (85,'default_post_format','0','yes');
INSERT INTO `d503h1e7s1_options` VALUES (86,'link_manager_enabled','0','yes');
INSERT INTO `d503h1e7s1_options` VALUES (87,'finished_splitting_shared_terms','1','yes');
INSERT INTO `d503h1e7s1_options` VALUES (88,'site_icon','0','yes');
INSERT INTO `d503h1e7s1_options` VALUES (89,'medium_large_size_w','768','yes');
INSERT INTO `d503h1e7s1_options` VALUES (90,'medium_large_size_h','0','yes');
INSERT INTO `d503h1e7s1_options` VALUES (91,'initial_db_version','38590','yes');
INSERT INTO `d503h1e7s1_options` VALUES (92,'d503h1e7s1_user_roles','a:5:{s:13:\"administrator\";a:2:{s:4:\"name\";s:13:\"Administrator\";s:12:\"capabilities\";a:61:{s:13:\"switch_themes\";b:1;s:11:\"edit_themes\";b:1;s:16:\"activate_plugins\";b:1;s:12:\"edit_plugins\";b:1;s:10:\"edit_users\";b:1;s:10:\"edit_files\";b:1;s:14:\"manage_options\";b:1;s:17:\"moderate_comments\";b:1;s:17:\"manage_categories\";b:1;s:12:\"manage_links\";b:1;s:12:\"upload_files\";b:1;s:6:\"import\";b:1;s:15:\"unfiltered_html\";b:1;s:10:\"edit_posts\";b:1;s:17:\"edit_others_posts\";b:1;s:20:\"edit_published_posts\";b:1;s:13:\"publish_posts\";b:1;s:10:\"edit_pages\";b:1;s:4:\"read\";b:1;s:8:\"level_10\";b:1;s:7:\"level_9\";b:1;s:7:\"level_8\";b:1;s:7:\"level_7\";b:1;s:7:\"level_6\";b:1;s:7:\"level_5\";b:1;s:7:\"level_4\";b:1;s:7:\"level_3\";b:1;s:7:\"level_2\";b:1;s:7:\"level_1\";b:1;s:7:\"level_0\";b:1;s:17:\"edit_others_pages\";b:1;s:20:\"edit_published_pages\";b:1;s:13:\"publish_pages\";b:1;s:12:\"delete_pages\";b:1;s:19:\"delete_others_pages\";b:1;s:22:\"delete_published_pages\";b:1;s:12:\"delete_posts\";b:1;s:19:\"delete_others_posts\";b:1;s:22:\"delete_published_posts\";b:1;s:20:\"delete_private_posts\";b:1;s:18:\"edit_private_posts\";b:1;s:18:\"read_private_posts\";b:1;s:20:\"delete_private_pages\";b:1;s:18:\"edit_private_pages\";b:1;s:18:\"read_private_pages\";b:1;s:12:\"delete_users\";b:1;s:12:\"create_users\";b:1;s:17:\"unfiltered_upload\";b:1;s:14:\"edit_dashboard\";b:1;s:14:\"update_plugins\";b:1;s:14:\"delete_plugins\";b:1;s:15:\"install_plugins\";b:1;s:13:\"update_themes\";b:1;s:14:\"install_themes\";b:1;s:11:\"update_core\";b:1;s:10:\"list_users\";b:1;s:12:\"remove_users\";b:1;s:13:\"promote_users\";b:1;s:18:\"edit_theme_options\";b:1;s:13:\"delete_themes\";b:1;s:6:\"export\";b:1;}}s:6:\"editor\";a:2:{s:4:\"name\";s:6:\"Editor\";s:12:\"capabilities\";a:34:{s:17:\"moderate_comments\";b:1;s:17:\"manage_categories\";b:1;s:12:\"manage_links\";b:1;s:12:\"upload_files\";b:1;s:15:\"unfiltered_html\";b:1;s:10:\"edit_posts\";b:1;s:17:\"edit_others_posts\";b:1;s:20:\"edit_published_posts\";b:1;s:13:\"publish_posts\";b:1;s:10:\"edit_pages\";b:1;s:4:\"read\";b:1;s:7:\"level_7\";b:1;s:7:\"level_6\";b:1;s:7:\"level_5\";b:1;s:7:\"level_4\";b:1;s:7:\"level_3\";b:1;s:7:\"level_2\";b:1;s:7:\"level_1\";b:1;s:7:\"level_0\";b:1;s:17:\"edit_others_pages\";b:1;s:20:\"edit_published_pages\";b:1;s:13:\"publish_pages\";b:1;s:12:\"delete_pages\";b:1;s:19:\"delete_others_pages\";b:1;s:22:\"delete_published_pages\";b:1;s:12:\"delete_posts\";b:1;s:19:\"delete_others_posts\";b:1;s:22:\"delete_published_posts\";b:1;s:20:\"delete_private_posts\";b:1;s:18:\"edit_private_posts\";b:1;s:18:\"read_private_posts\";b:1;s:20:\"delete_private_pages\";b:1;s:18:\"edit_private_pages\";b:1;s:18:\"read_private_pages\";b:1;}}s:6:\"author\";a:2:{s:4:\"name\";s:6:\"Author\";s:12:\"capabilities\";a:10:{s:12:\"upload_files\";b:1;s:10:\"edit_posts\";b:1;s:20:\"edit_published_posts\";b:1;s:13:\"publish_posts\";b:1;s:4:\"read\";b:1;s:7:\"level_2\";b:1;s:7:\"level_1\";b:1;s:7:\"level_0\";b:1;s:12:\"delete_posts\";b:1;s:22:\"delete_published_posts\";b:1;}}s:11:\"contributor\";a:2:{s:4:\"name\";s:11:\"Contributor\";s:12:\"capabilities\";a:5:{s:10:\"edit_posts\";b:1;s:4:\"read\";b:1;s:7:\"level_1\";b:1;s:7:\"level_0\";b:1;s:12:\"delete_posts\";b:1;}}s:10:\"subscriber\";a:2:{s:4:\"name\";s:10:\"Subscriber\";s:12:\"capabilities\";a:2:{s:4:\"read\";b:1;s:7:\"level_0\";b:1;}}}','yes');
INSERT INTO `d503h1e7s1_options` VALUES (93,'fresh_site','0','yes');
INSERT INTO `d503h1e7s1_options` VALUES (94,'widget_search','a:2:{i:2;a:1:{s:5:\"title\";s:0:\"\";}s:12:\"_multiwidget\";i:1;}','yes');
INSERT INTO `d503h1e7s1_options` VALUES (95,'widget_recent-posts','a:2:{i:2;a:2:{s:5:\"title\";s:0:\"\";s:6:\"number\";i:5;}s:12:\"_multiwidget\";i:1;}','yes');
INSERT INTO `d503h1e7s1_options` VALUES (96,'widget_recent-comments','a:2:{i:2;a:2:{s:5:\"title\";s:0:\"\";s:6:\"number\";i:5;}s:12:\"_multiwidget\";i:1;}','yes');
INSERT INTO `d503h1e7s1_options` VALUES (97,'widget_archives','a:2:{i:2;a:3:{s:5:\"title\";s:0:\"\";s:5:\"count\";i:0;s:8:\"dropdown\";i:0;}s:12:\"_multiwidget\";i:1;}','yes');
INSERT INTO `d503h1e7s1_options` VALUES (98,'widget_meta','a:2:{i:2;a:1:{s:5:\"title\";s:0:\"\";}s:12:\"_multiwidget\";i:1;}','yes');
INSERT INTO `d503h1e7s1_options` VALUES (99,'sidebars_widgets','a:8:{s:19:\"wp_inactive_widgets\";a:0:{}s:15:\"sidebar-primary\";a:6:{i:0;s:8:\"search-2\";i:1;s:14:\"recent-posts-2\";i:2;s:17:\"recent-comments-2\";i:3;s:10:\"archives-2\";i:4;s:12:\"categories-2\";i:5;s:6:\"meta-2\";}s:14:\"sidebar-footer\";a:0:{}s:13:\"widget-header\";a:0:{}s:11:\"widget-left\";N;s:12:\"widget-right\";N;s:13:\"widget-footer\";N;s:13:\"array_version\";i:3;}','yes');
INSERT INTO `d503h1e7s1_options` VALUES (100,'widget_pages','a:1:{s:12:\"_multiwidget\";i:1;}','yes');
INSERT INTO `d503h1e7s1_options` VALUES (101,'widget_calendar','a:1:{s:12:\"_multiwidget\";i:1;}','yes');
INSERT INTO `d503h1e7s1_options` VALUES (102,'widget_tag_cloud','a:1:{s:12:\"_multiwidget\";i:1;}','yes');
INSERT INTO `d503h1e7s1_options` VALUES (103,'widget_nav_menu','a:1:{s:12:\"_multiwidget\";i:1;}','yes');
INSERT INTO `d503h1e7s1_options` VALUES (104,'cron','a:3:{i:1484595790;a:3:{s:16:\"wp_version_check\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}s:17:\"wp_update_plugins\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}s:16:\"wp_update_themes\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}}i:1484595822;a:1:{s:19:\"wp_scheduled_delete\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:5:\"daily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:86400;}}}s:7:\"version\";i:2;}','yes');
INSERT INTO `d503h1e7s1_options` VALUES (106,'_site_transient_update_core','O:8:\"stdClass\":4:{s:7:\"updates\";a:1:{i:0;O:8:\"stdClass\":10:{s:8:\"response\";s:6:\"latest\";s:8:\"download\";s:59:\"https://downloads.wordpress.org/release/wordpress-4.7.1.zip\";s:6:\"locale\";s:5:\"en_US\";s:8:\"packages\";O:8:\"stdClass\":5:{s:4:\"full\";s:59:\"https://downloads.wordpress.org/release/wordpress-4.7.1.zip\";s:10:\"no_content\";s:70:\"https://downloads.wordpress.org/release/wordpress-4.7.1-no-content.zip\";s:11:\"new_bundled\";s:71:\"https://downloads.wordpress.org/release/wordpress-4.7.1-new-bundled.zip\";s:7:\"partial\";b:0;s:8:\"rollback\";b:0;}s:7:\"current\";s:5:\"4.7.1\";s:7:\"version\";s:5:\"4.7.1\";s:11:\"php_version\";s:5:\"5.2.4\";s:13:\"mysql_version\";s:3:\"5.0\";s:11:\"new_bundled\";s:3:\"4.7\";s:15:\"partial_version\";s:0:\"\";}}s:12:\"last_checked\";i:1484577063;s:15:\"version_checked\";s:5:\"4.7.1\";s:12:\"translations\";a:0:{}}','no');
INSERT INTO `d503h1e7s1_options` VALUES (111,'_site_transient_update_themes','O:8:\"stdClass\":4:{s:12:\"last_checked\";i:1484577065;s:7:\"checked\";a:1:{s:6:\"legion\";s:3:\"0.2\";}s:8:\"response\";a:0:{}s:12:\"translations\";a:0:{}}','no');
INSERT INTO `d503h1e7s1_options` VALUES (112,'_site_transient_timeout_browser_dff177876e22ddc43470e135e8edbe87','1485027791','no');
INSERT INTO `d503h1e7s1_options` VALUES (113,'_site_transient_browser_dff177876e22ddc43470e135e8edbe87','a:9:{s:8:\"platform\";s:9:\"Macintosh\";s:4:\"name\";s:6:\"Chrome\";s:7:\"version\";s:12:\"55.0.2883.95\";s:10:\"update_url\";s:28:\"http://www.google.com/chrome\";s:7:\"img_src\";s:49:\"http://s.wordpress.org/images/browsers/chrome.png\";s:11:\"img_src_ssl\";s:48:\"https://wordpress.org/images/browsers/chrome.png\";s:15:\"current_version\";s:2:\"18\";s:7:\"upgrade\";b:0;s:8:\"insecure\";b:0;}','no');
...
--
-- Table structure for table `d503h1e7s1_postmeta`
--

DROP TABLE IF EXISTS `d503h1e7s1_postmeta`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `d503h1e7s1_postmeta` (
  `meta_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `d503h1e7s1_postmeta`
--

LOCK TABLES `d503h1e7s1_postmeta` WRITE;
...
--
-- Table structure for table `d503h1e7s1_posts`
--

DROP TABLE IF EXISTS `d503h1e7s1_posts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `d503h1e7s1_posts` (
...
--
-- Dumping data for table `d503h1e7s1_posts`
--

LOCK TABLES `d503h1e7s1_posts` WRITE;
/*!40000 ALTER TABLE `d503h1e7s1_posts` DISABLE KEYS */;
INSERT INTO `d503h1e7s1_posts` VALUES (1,1,'2017-01-14 19:43:09','2017-01-14 19:43:09','Welcome to WordPress. This is your first post. Edit or delete it, then start writing!','Hello world!','','publish','open','open','','hello-world','','','2017-01-14 19:43:09','2017-01-14 19:43:09','',0,'http://localhost/?p=1',0,'post','',1);
...
--
-- Table structure for table `d503h1e7s1_term_relationships`
--

DROP TABLE IF EXISTS `d503h1e7s1_term_relationships`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `d503h1e7s1_term_relationships` (
...
--
-- Dumping data for table `d503h1e7s1_term_relationships`
--
...
--
-- Table structure for table `d503h1e7s1_term_taxonomy`
--

DROP TABLE IF EXISTS `d503h1e7s1_term_taxonomy`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `d503h1e7s1_term_taxonomy` (
...
--
-- Dumping data for table `d503h1e7s1_term_taxonomy`
--
...
--
-- Table structure for table `d503h1e7s1_termmeta`
--

DROP TABLE IF EXISTS `d503h1e7s1_termmeta`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `d503h1e7s1_termmeta` (
  `meta_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `term_id` bigint(20) unsigned NOT NULL DEFAULT '0',
  `meta_key` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `meta_value` longtext COLLATE utf8mb4_unicode_ci,
...
--
-- Dumping data for table `d503h1e7s1_termmeta`
--

LOCK TABLES `d503h1e7s1_termmeta` WRITE;
/*!40000 ALTER TABLE `d503h1e7s1_termmeta` DISABLE KEYS */;
/*!40000 ALTER TABLE `d503h1e7s1_termmeta` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `d503h1e7s1_terms`
--

DROP TABLE IF EXISTS `d503h1e7s1_terms`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `d503h1e7s1_terms` (
...
--
-- Dumping data for table `d503h1e7s1_terms`
--
...
--
-- Table structure for table `d503h1e7s1_usermeta`
--

DROP TABLE IF EXISTS `d503h1e7s1_usermeta`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `d503h1e7s1_usermeta` (
...
--
-- Dumping data for table `d503h1e7s1_usermeta`
--

LOCK TABLES `d503h1e7s1_usermeta` WRITE;
/*!40000 ALTER TABLE `d503h1e7s1_usermeta` DISABLE KEYS */;
INSERT INTO `d503h1e7s1_usermeta` VALUES (1,1,'nickname','root');
INSERT INTO `d503h1e7s1_usermeta` VALUES (2,1,'first_name','');
INSERT INTO `d503h1e7s1_usermeta` VALUES (3,1,'last_name','');
INSERT INTO `d503h1e7s1_usermeta` VALUES (4,1,'description','');
INSERT INTO `d503h1e7s1_usermeta` VALUES (5,1,'rich_editing','true');
...
INSERT INTO `d503h1e7s1_usermeta` VALUES (13,1,'dismissed_wp_pointers','');
INSERT INTO `d503h1e7s1_usermeta` VALUES (14,1,'show_welcome_panel','1');
INSERT INTO `d503h1e7s1_usermeta` VALUES (15,1,'session_tokens','a:1:{s:64:\"9dbca25d6fcc923e3fc202c662d323116307bd17000845ade04a00b5d56bd781\";a:4:{s:10:\"expiration\";i:1485632590;s:2:\"ip\";s:3:\"::1\";s:2:\"ua\";s:120:\"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.95 Safari/537.36\";s:5:\"login\";i:1484422990;}}');
...
--
-- Table structure for table `d503h1e7s1_users`
--

DROP TABLE IF EXISTS `d503h1e7s1_users`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `d503h1e7s1_users` (
  `ID` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `d503h1e7s1_users`
--

LOCK TABLES `d503h1e7s1_users` WRITE;
/*!40000 ALTER TABLE `d503h1e7s1_users` DISABLE KEYS */;
INSERT INTO `d503h1e7s1_users` VALUES (1,'root','$P$BlJm9dHhkGh78FWHCpw550FEIHV0gv0','root','tcmulder@gmail.com','','2017-01-14 19:43:09','',0,'root');
/*!40000 ALTER TABLE `d503h1e7s1_users` ENABLE KEYS */;
UNLOCK TABLES;
